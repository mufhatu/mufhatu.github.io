        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-8 h-8 rounded-lg animated-border p-px">
                <div className="w-full h-full bg-dark-800 rounded-[6px] flex items-center justify-center">
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              Building modern, scalable web experiences and cloud-native solutions from South Africa.
            </p>
            <div className="flex gap-3">
              {socialLinks.map((s) => (
                <motion.a
                  ...
                  whileHover={{ y: -2 }}
                  className="p-2 glass rounded-lg text-gray-400 hover:text-white glass-hover"
                  aria-label={s.label}
                >
                  {s.icon}
                </motion.a>
              ...
              {navLinks.map((link) => (
                <li key={link.to}>
                  <Link
                    ...
                    duration={600}
                    offset={-80}
                    className="text-gray-400 hover:text-primary-400 text-sm transition-colors cursor-pointer"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li>
                <a href={`mailto:${personal.email}`} className="hover:text-primary-400 transition-colors">
                  {personal.email}
                </a>
              </li>
